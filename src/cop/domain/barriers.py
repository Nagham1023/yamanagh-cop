...
placement (rules 15/16) is a network-layer concern with a peer to lie to;
it doesn't exist yet in PRD 1's single-process world, so it isn't enforced
here — only the placement rule itself and the quota are.
