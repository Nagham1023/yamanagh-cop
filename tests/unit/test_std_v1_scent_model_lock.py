...
Guide itself -- these tests only pin its own internal correctness and
its byte-for-bit parity with thief-peer's mirror of this module."""

from __future__ import annotations

import hashlib

from cop.std_v1.crypto import canonical
from cop.std_v1.scent_model_lock import build_scent_model_lock
...
def test_matches_thief_peers_own_declaration_bit_for_bit():
